...
╚═╝░░╚═╝╚═╝░░╚═╝╚═════╝░╚═╝░░░░░╚══════╝╚══════╝╚═╝░░╚═╝  ░░░╚═╝░░░╚══════╝╚═════╝░░░░╚═╝░░░╚═╝░░╚══╝╚══════╝░░░╚═╝░░░
    ...
    print_border("BOTANIX TESTNET", Fore.GREEN)
...
def get_available_scripts(language):
    scripts = {
        'vi': [
            {"name": "1. Deploy NFT - Quản lý bộ sưu tập NFT [ Tạo | Mint | Đốt ] | Botanix Testnet", "value": "nftcollection"},
            {"name": "2. Send TX ngẫu nhiên hoặc File (address.txt) | Botanix Testnet", "value": "sendtx"},
        ...
        'en': [          
            {"name": "1. Deploy NFT - Manage NFT Collection [ Create | Mint | Burn ] | Botanix Testnet", "value": "nftcollection"},
            {"name": "2. Send Random TX or File (address.txt) | Botanix Testnet", "value": "sendtx"},
            {"name": "3. Deploy Token smart-contract | Botanix Testnet", "value": "deploytoken"},
